...
import { Heart, MessageCircle, Share2, Calendar, Megaphone } from 'lucide-react';
                            ...
                            <div className="p-10 flex-1 space-y-6">
                                ...
                                <div className="pt-6 border-t border-rose-50 flex justify-between items-center">
                                    <div className="flex gap-4">
                                        <button className="flex items-center gap-2 text-gray-400 hover:text-primary transition-colors font-bold text-sm">
                                            <Heart size={20} />
                                            12
                                        </button>
                                        <button className="flex items-center gap-2 text-gray-400 hover:text-primary transition-colors font-bold text-sm">
