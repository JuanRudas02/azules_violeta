...
export default function PromotionsPage() {
    ...
    const promotions = posts.filter(p => p.type === 'promotion');
                                    ...
                                    <div className="mt-auto space-y-4">
                                        <div className="bg-secondary/50 p-4 rounded-2xl border-2 border-dashed border-rose-200 flex items-center justify-between">
                                            <div>
                                                ...
                                                <p className="text-lg font-black text-primary font-mono">{promo.discountCode}</p>
                                            </div>
                                            <button
                                                onClick={() => copyToClipboard(promo.discountCode!, promo.id)}
